    ...
    this.finalizeRecord = function(result, url) {
        ...
        // check if result is an array of records
            ...
            if ('prices' in result) {
                ...
                for (let i = 0; i < finalizedResult.prices.length; i++) {
            ...
            if ('descriptions' in finalizedResult)
                for (let i = 0; i < finalizedResult.descriptions.length; i++) {
            ...
            if ('merchants' in finalizedResult)
                for (let i = 0; i < finalizedResult.merchants.length; i++) {
            ...
            if ('leasingTerms' in finalizedResult)
                for (let i = 0; i < finalizedResult.leasingTerms.length; i++) {
            ...
            if ('managedBy' in finalizedResult)
                for (let i = 0; i < finalizedResult.managedBy.length; i++) {
            ...
            if ('nearbySchools' in finalizedResult)
                for (let i = 0; i < finalizedResult.nearbySchools.length; i++) {
            ...
            if ('statuses' in finalizedResult)
                for (let i = 0; i < finalizedResult.statuses.length; i++) {
            ...
            if ('unavailableDates' in finalizedResult)
                for (let i = 0; i < finalizedResult.unavailableDates.length; i++) {
